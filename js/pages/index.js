...
async function openIndexStoryModal(storyId) {
  try {
    ...
    document.getElementById('index-story-modal-title').textContent = story.title;
    document.getElementById('index-story-modal-image').src = story.image;
    document.getElementById('index-story-modal-category').textContent = story.category;
    document.getElementById('index-story-modal-author').textContent = story.author;
    document.getElementById('index-story-modal-role').textContent = story.authorRole;
    document.getElementById('index-story-modal-date').textContent = story.date;
    document.getElementById('index-story-modal-readtime').textContent = story.readTime;
    document.getElementById('index-story-modal-content').innerHTML = story.fullStory;
...
// Export login functions for global access
