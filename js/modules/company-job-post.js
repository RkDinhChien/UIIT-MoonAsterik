...
function closePostJobModal() {
	...
	techList.innerHTML =
		'<p id="no-tech-requirements" style="width: 100%; text-align: center; color: #999; font-style: italic; padding: 1rem 0; margin: 0;">No technical requirements added yet.</p>';
}
...
function getTechRequirements() {
	const techBadges = document.querySelectorAll(
		'#tech-requirements-list .tech-badge'
	);
...
function submitJobPosting() {
	...
	const jobData = {
		...
		salaryIncrease:
			parseFloat(document.getElementById('jobSalaryIncrease').value) || 0,
