...
function addTechStack() {
	...
	const techName = techInput ? techInput.value.trim() : '';
...
function checkNoTech() {
	...
	if (techList.children.length === 0) {
		techList.innerHTML =
			'<p id="no-techstack" style="width: 100%; text-align: center; color: #999; font-style: italic; padding: 2rem 0;">No technologies added yet. Add the tools and technologies your company uses.</p>';
	}
}
	...
	if (element) {
		...
		if (officesList.children.length === 0) {
			officesList.innerHTML =
				'<p id="no-offices" style="text-align: center; color: #999; font-style: italic; padding: 2rem 0;">No office locations added yet. Add your office addresses.</p>';
		}
	}
}
	...
	if (element) {
		...
		if (benefitsList.children.length === 0) {
			benefitsList.innerHTML =
				'<p id="no-benefits" style="text-align: center; color: #999; font-style: italic; padding: 2rem 0;">No benefits added yet. Highlight what makes your company a great place to work.</p>';
		}
	}
}
...
function removeSocialLink(id) {
	...
	if (element) {
		...
		if (linksList.children.length === 0) {
			linksList.innerHTML =
				'<p id="no-social-links" style="text-align: center; color: #999; font-style: italic; padding: 2rem 0;">No social links added yet. Add your company\'s social media profiles.</p>';
		}
	}
}
